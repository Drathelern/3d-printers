...
#define STRING_CONFIG_H_AUTHOR "(EIRP, Ender-3)" // Who made the changes.
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 190.25
  #define DEFAULT_bedKi 15.43
  #define DEFAULT_bedKd 586.54
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 3298.3 }
...
#define Z_SAFE_HOMING
  ...
  #define Z_SAFE_HOMING_X_POINT (((X_CENTER)  / 2) -10)  // X point for Z homing
  #define Z_SAFE_HOMING_Y_POINT (((Y_CENTER)  / 2) +2)   // Y point for Z homing
#endif
